...
public class WritePost extends AppCompatActivity {
    ...
    Toolbar toolbar;
    AdapterWritePost adapterWritePost;
    ...
    private void loadGroup() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterWritePost = new AdapterWritePost(WritePost.this, modelGroups );
                groupRv.setAdapter(adapterWritePost);
                adapterWritePost.notifyDataSetChanged();
            }
            @Override
